...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('fecha_nacimiento', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}
</div>

<!-- Ocupacion Field -->
<div class="form-group col-sm-6">
    {!! Form::label('ocupacion', 'Ocupacion:') !!}
    {!! Form::text('ocupacion', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}
</div>

<!-- Correo Electronico Field -->
<div class="form-group col-sm-6">
    {!! Form::label('correo_electronico', 'Correo Electronico:') !!}
    {!! Form::text('correo_electronico', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}
</div>

<!-- Tipo Field -->
<div class="form-group col-sm-6">
    {!! Form::label('tipo', 'Tipo:') !!}
    {!! Form::text('tipo', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}
</div>